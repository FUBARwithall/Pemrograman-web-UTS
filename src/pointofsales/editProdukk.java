...
public class editProdukk extends javax.swing.JDialog {
    ...
    public editProdukk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editProdukk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                editProdukk dialog = new editProdukk(new javax.swing.JFrame(), true);
